...
;##########################################################################
  ...
  ;
  ; IF source data is only from memory AND the FPU is specified as the destination for the result,
  ;       the st7 data register will become the st0 data register where the
  ;       result will be returned (any valid data in that register would have been trashed).
  ; -----------------------------------------------------------------------
    .386

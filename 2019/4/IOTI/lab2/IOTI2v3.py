...
n, m = map(int, input("Сколько в системе уравнений и переменных?\n").split())
ar = input_array(n, m)
print_array(ar, 'Матрица системы ограничений: \n')
k = int(input("Количество коэффициентов в целевой функции? "))
